...
class DataCreateCourier:
    # функция генерации фейковых валидных данных
    @staticmethod
    ...
    # функция генерации фейковых данных без поля "Login"
    @staticmethod
    ...
    # функция генерации фейковых данных без поля "Password"
    @staticmethod
